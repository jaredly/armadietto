...
class WebFinger extends Controller {
  ...
  isHTTPS () {
    ...
    console.log(this.rerquest.secure, this.request.connection && this.request.connection.authorized, this.server._forceSSL, this.request.socket && this.request.socket.secure);
    return (
      this.request.secure ||
      ...
      (this.request.headers['x-forwarded-scheme'] === 'https') ||
